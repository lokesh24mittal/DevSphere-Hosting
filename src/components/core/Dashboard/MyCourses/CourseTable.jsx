                ...
                <Tbody>
                    {
                        courses.length===0 ?(
                            ...
                            courses.map((course)=>(
                                <Tr key={course._id} className='flex gap-x-10 border-richblack-800 p-8 px-6'>
                                    ...
                                    <Td className='flex-gap-x=4 flex-1'>
                                        ...
                                        <div className='flex flex-col justify-between'>
                                            ...
                                            {course.status==COURSE_STATUS.DRAFT?(
                                                <p className='flex w-fit flex-row items-center gap-2 rounded-full
                                                bg-richblack-700 px-2 py-[2px] text-[12px] font-medium text-pink-100'>
                                                    <HiClock size={14}/>
                                                    Drafted
                                                </p>)
                                                :(
                                                    <p className='flex w-fit flex-row items-center gap-2 rounded-full
                                                bg-richblack-700 px-2 py-[2px] text-[12px] font-medium text-yellow-50'>
                                    ...
                                    <Td className='text-sm font-medium text-richblack-100'>
                                        <button disabled={loading} onClick={()=>{navigate(`edit-course/${course._id}`)}}
                                            className='px-2 transition-all duration-200 hower:scale-110 hover:text-caribbeangreen-300'
                                            >Edit
                                            <FiEdit2 size={20}/>
                                        </button>
