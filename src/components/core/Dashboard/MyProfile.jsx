    ...
    return (
        <>
            ...
            <div className='flex items-center justify-between rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-12'>
                ...
                <IconBtn text={"Edit"}
                    onClick={() => { navigate("/dashboard/settings") }} customClasses={"hidden md:flex"}>
                    <RiEditBoxLine />
                </IconBtn>
            </div>

            {/* section 2 */}
            <div className='my-10 flex flex-col gap-y-10 rounded-md boder-[1px] border-richblack-700 bg-richblack-800 p-8 px-12'>
