                ...
                <div className="relative w-fit h-fit shadow-blue-200 shadow-[0px_0px_30px_0px]">
                    <div className="absolute lg:left-[50%] lg:bottom-0 lg:translate-x-[-50%] lg:translate-y-[50%] bg-caribbeangreen-700 flex lg:flex-row flex-col text-white uppercase py-5 gap-4 lg:gap-0 lg:py-10">
                        ...
                        <div className="flex gap-5 items-center px-7 lg:px-14">
                            ...
                            <h1 className="text-caribbeangreen-300 text-sm w-[75px]">Type of courses</h1>
                        </div>
                        <div></div>
                    </div>
                    <img src={TimeLineLogo} alt="timeline image" className="shadow-white shadow-[20px_20px_0px_0px] object-cover h-[400px] lg:h-fit"/>
                </div>
